...
namespace NotificationSim
{
    public class ReceiveNotification
    {
        ...
        {
            string host = PAS.AutoTest.TestUtility.Utility.GetCSDMConfig(PAS.AutoTest.TestUtility.CSDMConfigSection.remote, "host");
            string port = PAS.AutoTest.TestUtility.Utility.GetCSDMConfig(PAS.AutoTest.TestUtility.CSDMConfigSection.remote, "notificationPort");
            init(host, int.Parse(port));
        }
